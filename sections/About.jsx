  ...
  <section className={`${styles.paddings} relative z-10`} >
    ...
    >
      ...
      <motion.p
        ...
        "
        >
          <span className="font-exrabold text-white" > Metaverse </span>
           ...
           <span className="font-exrabold text-white" > madness of the metaverse </span>
           

            of today, using only 

            <span className="font-exrabold text-white" > VR </span>
            

           devices you can easily explore the metaverse world you want, turn your dreams into reality. Let's 

           
           <span className="font-exrabold text-white" > explore </span>
